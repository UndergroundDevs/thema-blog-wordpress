...
<?php get_footer(); ?>
        <!--fim do player de audio-->
    </section>
    <script src="assest/js/jquery.min.js"></script>
    <script src="assest/js/bootstrap.min.js"></script>
    <script src="assest/js/bs-init.js"></script>
    <script src="https://cdnjs.cloudflare.com/ajax/libs/aos/2.1.1/aos.js"></script>
    <script src="https://cdnjs.cloudflare.com/ajax/libs/jquery-easing/1.4.1/jquery.easing.min.js"></script>
    <script src="https://cdnjs.cloudflare.com/ajax/libs/magnific-popup.js/1.1.0/jquery.magnific-popup.min.js"></script>
    <script src="assest/js/creative.js"></script>
                ...
                <div class="row">
                    ...
                    <div class="col-xs-12 col-sm-6 col-md-3">
                        <div class="widget subscribe no-box">
                            <h5 class="widget-title">UNDERGROUND DEVS<span></span></h5>
                            <p>Underground DEVs, atingindo suas profundezas da maneira mais emocionante.</p>
                        </div>
                    </div>
                    ...
                    <div class="col-xs-12 col-sm-6 col-md-4">
                        <div class="widget no-box">
                            <h5 class="widget-title">contate-nos<span></span></h5>

                            <p><a href="mailto:underdevs.community@gmail.com" title="glorythemes">underdevs.community@gmail.com</a></p>
                            <ul class="social-footer2">
                                ...
                                <li class="">
                                    <a title="GitHub" target="_blank" href="https://github.com/UndergroundDevs"><img alt="GitHub" width="25" height="25" src="assest/img/githubIcon.png"></a>
                                </li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div class="col-xs-12 col-sm-6 col-md-3">
                        <div class="widget no-box">
                            <h5 class="widget-title">Rádio<span></span></h5>
                            <!--player de audio-->
                            <link rel="stylesheet" href="style.css" rel="stylesheet">
                            <!--<script src="js/AudioPlayer.js">
                            </script>-->
                            <div id="main">
                                <img id="imgPlayer" src="assest/img/logo_16x9.jpg">
                                <div id="player">
                                    <div id="buttons">
                                        <button id="play" onclick="playOrPauseSong()">
                                <img src="assest/img/Play.png">
                            </button>
                                    </div>
                                </div>
                                <div class="slidecontainer">
                                    <input type="range" min="1" max="100" value="25" class="slider" id="volbar">
                                    <script>
                                        var audio = new Audio('http://stream.zeno.fm/0hx17x9nwtzuv'); // the above
                                        audio.play();
                                        audio.pause();
                                        audio.volume = 0.25;

                                        var slider = document.getElementById("volbar");
                                        ...
                                        function playOrPauseSong() {
                                            ...
                                            if (audio.paused) {
                                                audio.play();
                                                $("#play img").attr("src", "assest/img/Pause.png");
                                            } else {
                                                audio.pause();
                                                $("#play img").attr("src", "assest/img/Play.png");
                                            }
                                        }
                                    </script>
                                </div>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-12 text-center">
                            <p>Copyright Underground DEVs © 2020. All rights reserved.</p>
                        </div>
                    </div>
                </div>
            </div>
