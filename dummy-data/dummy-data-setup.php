 ...
 * Set import files
 */
function gohost_set_import_files() {
    return array(
        array(
            'import_file_name'           => __('Dummy-data', 'gohost'),
            'local_import_file'          => trailingslashit( get_template_directory() ) . 'dummy-data/dummy-data.xml',
        ),
    );
}
add_filter( 'pt-ocdi/import_files', 'gohost_set_import_files' );

/**
 * Define actions that happen after import
 */
function gohost_actions_after_import() {
...
add_action( 'pt-ocdi/after_import', 'gohost_actions_after_import' );
