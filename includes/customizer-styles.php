...
function twx_custom_styles( $customizer_style ) {
	...
	//Background color
	$primary_color = get_theme_mod( 'primary_color', '#4536d1' );
	$customizer_style .= '.banner-button, button, input[type="submit"], input[type="button"], input[type="reset"], .to-top, #site-navigation .sub-menu li:hover > a, .site-footer { background-color: ' . $primary_color . ' }';
	...
	//secondary color
	$secondary_color = get_theme_mod( 'secondary_color', '#00ffff' );
	$customizer_style .= '.btn-menu, .breadcrumb a, .banner-button:hover, .site-footer a,  #site-navigation ul li a:hover, button, input[type="submit"], input[type="button"]  {color: ' . $secondary_color . ' }';
	
	$customizer_style .= '.banner-button:hover {border-color: ' . $secondary_color . ' }';
	
	$customizer_style .= '#site-navigation ul li::before  {background-color: ' . $secondary_color . ' }';
