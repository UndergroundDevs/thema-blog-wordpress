...
function gohost_banner_background() {
	
	$title = get_theme_mod('banner_sub_title', __('', 'gohost'));
	$fornt_img = get_theme_mod('banner_side_img','');
	$subtitle = get_theme_mod('banner_main_title', __('The simplest cloud platform for Developer & teams', 'gohost'));
	$subpera = get_theme_mod('banner_para', __('Lorem ipsum dolor sit amet, consectetur adipiscing elit. Morbi imperdiet ullamcorper erat. Lorem ipsum dolor sit amet, consectetur adipiscing elit.', 'gohost'));
	$button_text1 = get_theme_mod('banner_btn1_txt', __('Ready to start', 'gohost'));
	$button_text2 = get_theme_mod('banner_btn2_txt', __('', 'gohost'));
