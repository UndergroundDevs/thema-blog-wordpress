...
add_action( 'customize_register', 'gohost_customize_register' );
function gohost_customize_register( $wp_customize ) {
	
	//$wp_customize->get_section( 'header_image' )->panel = 'gohost_header_panel';
	...
	$wp_customize->add_panel( 'header_top_panel', array(
		'title' => __( 'Header Top Section', 'gohost' ),
		'description' => __( 'Change the font size and color for Site Title, Site Tagline and Menu', 'gohost' ), // Include html tags such as <p>.
		'priority' => 1, // Mixed with top-level-section hierarchy.
		) );
		
		//Site Title section
		$wp_customize->add_section( 'site_title_section', array(
			'title' => __( 'Site Title' , 'gohost' ),
			...
			$wp_customize->add_control( new WP_Customize_Color_Control(
				$wp_customize, 'site_title_color', array(
					...
					'label' => __( 'Color', 'gohost' ),
					'description' => __( 'Change color of site title', 'gohost' ),
					) )
				);
		
		//Site Tagline section
		$wp_customize->add_section( 'site_tagline_section', array(
			'title' => __( 'Site Tagline' , 'gohost' ),
			'panel' => 'header_top_panel',
			'priority' => 2,
			'capability' => 'edit_theme_options',
			) );
			...
			$wp_customize->add_control( new WP_Customize_Color_Control(
				$wp_customize, 'tagline_color', array(
					...
					'label' => __( 'Color', 'gohost' ),
					'description' => __( 'Change color of site tagline', 'gohost' ),
					) ) );
			
	/*--- Header Banner ---*/
	$wp_customize->add_panel( 'header_banner', array(
		'title' => __( 'Header Banner', 'gohost' ),
		'description' => __( 'Change the font size and color for Site Title, Site Tagline and Menu', 'gohost' ),
		'priority' => 2,
		) );
	
		//Banner type section
		$wp_customize->add_section( 'banner_type_section', array(
			'title' => __( 'Banner Type' , 'gohost' ),
			'panel' => 'header_banner',
			'priority' => 1,
			'capability' => 'edit_theme_options',
			) );
			...
			$wp_customize->add_control( 'banner_type', array(
				...
				'label' => __( 'Fron page banner type', 'gohost' ),
				'description' => __( 'Select banner type for front page', 'gohost' ),
				'choices' => array(
					'bg-color' => __( 'Background Color', 'gohost' ),
					'bg-gradient' => __( 'Background Gradient', 'gohost' ),
					'image' => __( 'Background Image', 'gohost' ),
					'video' => __( 'Background Video', 'gohost' ),
					'bgnone' => __( 'Background none', 'gohost' ),
				),
				) );
			...
			$wp_customize->add_control( 'banner_height', array(
				...
				'label' => __( 'Height of banner (Default: 700px)', 'gohost' ),
				'input_attrs' => array(
					'min' => 0,
					'max' => 2000,
					'step' => 1,
		...
		$wp_customize->add_section( 'banner_bg_color_section', array(
			'title' => __( 'Banner Background: Color' , 'gohost' ),
			'panel' => 'header_banner',
			'priority' => 2,
			'capability' => 'edit_theme_options',
			) );
			...
			$wp_customize->add_control( new WP_Customize_Color_Control(
				$wp_customize, 'banner_bg_color', array(
					...
					'label' => __( 'Background Color', 'gohost' ),
					'description' => __( 'Change background color of banner', 'gohost' ),
				) ) );
			
		//Banner background Gradient section
		$wp_customize->add_section( 'banner_bg_gradient_section', array(
			'title' => __( 'Banner Background: Gradient' , 'gohost' ),
			'panel' => 'header_banner',
			'priority' => 3,
			'capability' => 'edit_theme_options',
			'description' => __( 'Choose the colors below to give gradient background to your banner', 'gohost' ),
			) );
			...
			$wp_customize->add_control( new WP_Customize_Color_Control(
				$wp_customize, 'banner_bg_gradient_1', array(
					...
					'label' => __( 'Gradient color 1', 'gohost' ),
					'description' => __( 'Add 1st Gradient color', 'gohost' ),
					) ) );
			...
			$wp_customize->add_control( new WP_Customize_Color_Control(
				$wp_customize, 'banner_bg_gradient_2', array(
					...
					'label' => __( 'Gradient color 2', 'gohost' ),
					'description' => __( 'Add 2nd Gradient color', 'gohost' ),
					) ) );
			...
			$wp_customize->add_control( new WP_Customize_Color_Control(
				$wp_customize, 'banner_bg_gradient_3', array(
					...
					'label' => __( 'Gradient color 3', 'gohost' ),
					'description' => __( 'Add 3rd Gradient color', 'gohost' ),
					) ) );
		
		//Banner background image section
		$wp_customize->add_section( 'banner_bg_img_section', array(
			'title' => __( 'Banner Background: Image' , 'gohost' ),
			'panel' => 'header_banner',
			'priority' => 4,
			'capability' => 'edit_theme_options',
			'description' => __( 'Upload image and set other settings for banner background', 'gohost' ),
			) );
			...
			$wp_customize->add_control( new WP_Customize_Image_Control(
				$wp_customize, 'banner_bg_img', array(
					...
					'label' => __( 'Upload image for background', 'gohost' ),
					) ) );
			...
			$wp_customize->add_control( 'banner_bg_size', array(
				...
				'label' => __( 'Banner background size', 'gohost' ),
				'choices' => array(
					'cover' => __( 'cover', 'gohost' ),
					'contain' => __( 'contain', 'gohost' ),
				),
				) );
			...
			$wp_customize->add_control( 'banner_bg_pos', array(
				...
				'label' => __( 'Banner background position', 'gohost' ),
				'choices' => array(
					'top-left' => __( 'top left', 'gohost' ),
					'top-center' => __( 'top center', 'gohost' ),
					'top-right' => __( 'top right', 'gohost' ),
					'center-left' => __( 'center left', 'gohost' ),
					'center-center' => __( 'center center', 'gohost' ),
					'center-right' => __( 'center right', 'gohost' ),
					'bottom-left' => __( 'bottom left', 'gohost' ),
					'bottom-center' => __( 'bottom center', 'gohost' ),
					'bottom-right' => __( 'bottom right', 'gohost' ),
				),
				) );
			...
			$wp_customize->add_control( 'banner_bg_repeat', array(
				...
				'label' => __( 'Banner background no-repeat', 'gohost' ),
				) );
			
		//Banner content section
		$wp_customize->add_section( 'banner_content_section', array(
			'title' => __( 'Banner content' , 'gohost' ),
			'panel' => 'header_banner',
			'priority' => 5,
			'capability' => 'edit_theme_options',
			'description' => __( 'Form here you can change the text of all titles, subititle and paragraph present on banner', 'gohost' ),
			) );
		
			//Banner main title
			$wp_customize->add_setting( 'banner_main_title', array(
				'capability' => 'edit_theme_options',
				'default' => __( 'Delivers more than expected', 'gohost' ),
				'transport' => 'refresh',
			...
			$wp_customize->add_control( 'banner_main_title', array(
				...
				'label' => __( 'Banner main title', 'gohost' ),
				) );
			...
			$wp_customize->add_control( 'banner_sub_title', array(
				...
				'label' => __( 'Banner sub title', 'gohost' ),
				) );
			
			//Banner paragraph
			$wp_customize->add_setting( 'banner_para', array(
				'capability' => 'edit_theme_options',
				'default' => __( 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Morbi imperdiet ullamcorper erat. Lorem ipsum dolor sit amet, consectetur adipiscing elit.', 'gohost' ),
				'transport' => 'refresh',
				'sanitize_callback' => 'wp_filter_nohtml_kses',
				) );
			...
			$wp_customize->add_control( 'banner_para', array(
				...
				'label' => __( 'Banner paragraph', 'gohost' ),
				) );
			
			//Banner button1 text
			$wp_customize->add_setting( 'banner_btn1_txt', array(
				'capability' => 'edit_theme_options',
				'default' => __( 'Ready to start', 'gohost' ),
				'transport' => 'refresh',
				'sanitize_callback' => 'wp_filter_nohtml_kses',
				) );
			...
			$wp_customize->add_control( 'banner_btn1_txt', array(
				...
				'label' => __( 'Banner 1st button text', 'gohost' ),
				) );
			...
			$wp_customize->add_control( 'banner_btn1_url', array(
				...
				'label' => __( 'Banner 1st button url', 'gohost' ),
				) );
			...
			$wp_customize->add_control( 'banner_btn2_txt', array(
				...
				'label' => __( 'Banner 2nd button text', 'gohost' ),
				) );
			...
			$wp_customize->add_control( 'banner_btn2_url', array(
				...
				'label' => __( 'Banner 2nd button url', 'gohost' ),
				) );
			...
			$wp_customize->add_control( new WP_Customize_Image_Control(
				$wp_customize, 'banner_side_img', array(
					...
					'label' => __( 'Upload side image for banner', 'gohost' ),
					) ) );
				
	
	/*--- General settings ---*/
	$wp_customize->add_panel( 'general_settings', array(
		'title' => __( 'General settings', 'gohost' ),
		'priority' => 3,
		) );
		
		//Page padding section
		$wp_customize->add_section( 'page_padding', array(
			'title' => __( 'Main page padding' , 'gohost' ),
			'panel' => 'general_settings',
			'priority' => 1,
			'capability' => 'edit_theme_options',
			'description' => __( 'Form here you can change the top and bottom padding of page', 'gohost' ),
			) );
			...
			$wp_customize->add_control( 'page_top_padding', array(
				...
				'label' => __( 'Space between header and page content (in px)', 'gohost' ),
				'input_attrs' => array(
					'min' => 0,
					'max' => 500,
					'step' => 1,
			...
			$wp_customize->add_control( 'page_bottom_padding', array(
				...
				'label' => __( 'Space between footer and page content (in px)', 'gohost' ),
				'input_attrs' => array(
					'min' => 0,
					'max' => 500,
					'step' => 1,
	...
	$wp_customize->add_panel( 'theme_blog_panel', array(
		'title' => __( 'Blogs Panel', 'gohost' ),
		'priority' => 4,
		) );
		
		//Blog layout
		$wp_customize->add_section( 'theme_blog_layout', array(
			'title' => __( 'Blog layout' , 'gohost' ),
			...
			$wp_customize->add_control( 'theme_blog_type', array(
				...
				'label' => __( 'Select blog layout', 'gohost' ),
				'description' => __( 'This will change the styling of blogs on blog and single blog page', 'gohost' ),
				'choices' => array(
					'default' => __( 'Default', 'gohost' ),
					'special' => __( 'Special', 'gohost' ),
				),
				) );
			...
			$wp_customize->add_control( 'show_sidebar', array(
				...
				'label' => __( 'Check this box to show sidebar on blogs page', 'gohost' ),
				) );
			...
			$wp_customize->add_control( 'show_sidebar_single', array(
				...
				'label' => __( 'Check this box to show sidebar on single blog page', 'gohost' ),
				) );
	...
	/*--- Colors panel ---*/		
			...
			$wp_customize->add_control( new WP_Customize_Color_Control(
				$wp_customize, 'primary_color', array(
					...
					'label' => __( 'Primary color', 'gohost' ),
					'description' => __( 'Change in this color will change the primary color of whole theme', 'gohost' ),
					) ) );
			...
			$wp_customize->add_control( new WP_Customize_Color_Control(
				$wp_customize, 'secondary_color', array(
					...
					'label' => __( 'Secondary color', 'gohost' ),
					'description' => __( 'Change in this color will change the secondary color of whole theme', 'gohost' ),
					) ) );
			...
			$wp_customize->add_control( new WP_Customize_Color_Control(
				$wp_customize, 'theme_text_color', array(
					...
					'label' => __( 'Theme text color', 'gohost' ),
					'description' => __( 'Change in this color will change the text color of whole theme (basically all paragraphs).', 'gohost' ),
					) ) );
}
...
function twx_sntz_banner_type( $value ){
	$valid = array(
        'bg-color' => __( 'Color', 'gohost' ),
		'bg-gradient' => __( 'Gradient', 'gohost' ),
		'image' => __( 'Image', 'gohost' ),
		'video' => __( 'Video', 'gohost' ),
		'bgnone' => __( 'Background None', 'gohost' ),
		'carousel' => __( 'Background Carousel', 'gohost' ),
	);
	return ( array_key_exists( $value, $valid ) ? $value : '' );
}

function gohost_sanitize_menu( $value ){
	$valid = array(
		'sticky'   => __('Sticky', 'gohost'),
		'static'   => __('Static', 'gohost'),
	);
	return ( array_key_exists( $value, $valid ) ? $value : '' );
}
...
function gohost_sanitize_widget_area($value){
	$valid = array(
		'1'     => __('One', 'gohost'),
		'2'     => __('Two', 'gohost'),
		'3'     => __('Three', 'gohost'),
...
function gohost_sanitize_wc_content($value){
	$valid = array(
		'left'    => __('Left', 'gohost'),
		'right'     => __('Right', 'gohost'),
	);
	return ( array_key_exists( $value, $valid ) ? $value : '' );
}

function gohost_sanitize_image( $input ){
